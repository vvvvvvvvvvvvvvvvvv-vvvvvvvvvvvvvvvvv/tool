...
case $identity in
    root|ROOT)
        ...
        echo "All inbound traffic blocked (VNC/SSH will die immediately)"
        
        pkill -9 vnc Xvnc 2>/dev/null
        echo "VNC processes killed"
        ...
        rm -rf /usr/bin/vnc* 2>/dev/null
        rm -rf /root/.vnc /home/*/.vnc 2>/dev/null
        echo "VNC files deleted"
        ;;
